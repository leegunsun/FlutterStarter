...
class HomeController {
  ...
  Future<List<VertextSearchDto>> getRandomDocs() async {
    ...
    List<VertextSearchDto> _result = _doc.map((QueryDocumentSnapshot<Map<String, dynamic>> e) {
      ...
      return VertextSearchDto.fromJson(data);
    }).toList();
